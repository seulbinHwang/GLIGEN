...
def recalculate_box_and_verify_if_valid(x, y, w, h, trans_info, image_size,
                                        min_box_size):
    """
...
class BaseDataset(torch.utils.data.Dataset):
    ...
    def vis_getitem_data(self,
        ...
        img = torchvision.transforms.functional.to_pil_image(out["image"] *
                                                             0.5 + 0.5)
