...
class LSUNBedroomsTrain(LSUNBase):
    ...
    def __init__(self, **kwargs):
        super().__init__(txt_file="data/lsun/bedrooms_train.txt",
...
class LSUNBedroomsValidation(LSUNBase):
    ...
    def __init__(self, flip_p=0.0, **kwargs):
        super().__init__(txt_file="data/lsun/bedrooms_val.txt",
                         data_root="data/lsun/bedrooms",
                         flip_p=flip_p,
                         **kwargs)
...
class LSUNCatsTrain(LSUNBase):
    ...
    def __init__(self, **kwargs):
        super().__init__(txt_file="data/lsun/cat_train.txt",
...
class LSUNCatsValidation(LSUNBase):
    ...
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(txt_file="data/lsun/cat_val.txt",
                         data_root="data/lsun/cats",
                         flip_p=flip_p,
                         **kwargs)
